object frmMain: TfrmMain
  Left = 0
  Top = 0
  Caption = 'Servidor Base64 para Bitmap / Bitmap para Base64'
  ClientHeight = 461
  ClientWidth = 629
  Color = clBtnFace
  ...
  object gbRequest: TGroupBox
    ...
    object pnlBottom: TPanel
      ...
      object lblVisualizarBase64Browser: TLinkLabel
        Left = 210
        Top = 4
        Width = 144
        Height = 19
        Cursor = crHandPoint
        Caption = 'lblVisualizarBase64Browser'
        TabOrder = 2
        UseVisualStyle = True
        Visible = False
        OnLinkClick = lblVisualizarBase64BrowserLinkClick
      end
      object lblVisualizarBitmapBrowser: TLinkLabel
        Left = 20
        Top = 4
        Width = 146
        Height = 19
        Cursor = crHandPoint
        Caption = 'lblVisualizarBitmapBrowser'
        TabOrder = 3
        UseVisualStyle = True
        Visible = False
        OnLinkClick = lblVisualizarBase64BrowserLinkClick
  ...
  object mtRequest: TFDMemTable
    ...
    object mtRequestMENSAGEM: TStringField
