...
uses
  System.Types, System.Net.Mime, Utils.Image, Vcl.Imaging.jpeg, Vcl.Imaging.pngimage, Vcl.Imaging.GIFImg;
...
begin
  ...
  lBitmap := nil;
  try
    lBitmap := TImageUtils.Base64ToBitmap(lHTTPResponse.ContentStream);
